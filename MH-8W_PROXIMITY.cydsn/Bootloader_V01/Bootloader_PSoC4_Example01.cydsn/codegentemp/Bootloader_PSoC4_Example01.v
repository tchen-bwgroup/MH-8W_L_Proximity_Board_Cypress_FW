// ======================================================================
// Bootloader_PSoC4_Example01.v generated from TopDesign.cysch
// 07/19/2017 at 16:25
...
module top ;
	...
	wire [0:0] tmpOE__Bootloader_Status_net;
	wire [0:0] tmpFB_0__Bootloader_Status_net;
	wire [0:0] tmpIO_0__Bootloader_Status_net;
	wire [0:0] tmpINTERRUPT_0__Bootloader_Status_net;
	electrical [0:0] tmpSIOVREF__Bootloader_Status_net;

	cy_psoc3_pins_v1_10
		#(.id("8e4f82fa-7adb-41e7-a1ea-8ca42deb1e3e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Bootloader_Status
		 (.oe(tmpOE__Bootloader_Status_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Bootloader_Status_net[0:0]}),
		  .io({tmpIO_0__Bootloader_Status_net[0:0]}),
		  .siovref(tmpSIOVREF__Bootloader_Status_net),
		  .interrupt({tmpINTERRUPT_0__Bootloader_Status_net[0:0]}),
		  .annotation({Net_1782}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Bootloader_Status_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
